  ...
  const sidebarContent = (
    <div className="h-full flex flex-col min-w-0 max-w-full overflow-x-hidden">
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex-1 flex flex-col min-w-0">
        ...
        <TabsContent value="templates" className="flex-1 px-3 pb-3 pt-2 mt-8 min-w-0 max-w-full overflow-x-hidden overflow-y-auto">
        ...
        <TabsContent value="layers" className="flex-1 px-3 pb-3 pt-2 mt-8 min-w-0 max-w-full overflow-x-hidden overflow-y-auto">
          <div className="min-w-0 max-w-full">
            <UnifiedLayerPanel 
              context={{
                layers,
